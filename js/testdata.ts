...
It might be more apt to think about it as #COVIDISM and to see it as a subset of #Marxism, rather than Communism, which is an endpoint hoped to occur after the "double negation" (elimination of the tyrannical Socialist state)
...
// export const example_text = `🧵On Feminism's futile use of critical structuralism to differentiate itself from Queer Theory.
...
// `🧵On specializing drag queens for children
...
// export const example_posts = [
//   `🧵On Feminism's futile use of critical structuralism to differentiate itself from Queer Theory.
...
export const covidism = `'🧵\n  It might be more apt to think about it as #COVIDISM and to see it as a subset of #Marxism, rather than Communism, which is an endpoint hoped to occur after the \\"double negation\\" (elimination of the tyrannical Socialist state)\n\n\n  It's important, in the vein of Marxist dualism, to remember that contradictions are part of the synthesis. One of the most striking is that left and right-leaning dispositions can come to be synthesized, particularly under the threat of infection and disease (di… Totalitarian structure - those who benefit from an empowered structure label themselves as liberatory / equitable, while they are criticized by those who have a real problem with what has always been understood as Fascism (merger of private/public, everything within the \\"state\\", etc)\n  - Resistance to transformation is always publicly associated with traditional fascistic imagery (Neo-Nazis, white supremacy, etc)\n  - #FreedomConvoy \\"prevents movement\\" and \\"destroys people's freedom\n  fin'`
...
const requests = [
  { user: "DEFAULT_USER",
    ...
    ../`,
    time: 1,
    urls: "https://stronglogicsolutions.com/stronglogic01.png>"
  },
  { user: "DEFAULT_USER",
    text: `Middle of thread
    ../`,
    time: 2,
    urls: ""
  },
